...
if ($stmt) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Debugging: Display the full result for verification
        echo "<pre>";
        print_r($row); // Debugging for retrieved data
        echo "</pre>";
        ...
        $sql_fetch_info = "SELECT work_instruction, information, packaging, master_parameter, current_parameter FROM parts WHERE part_number = ?";
